...
from wideresnet_models import group_lasso_WideResNet
...
parser.add_argument('--name', default='group_lasso_WideResNet', type=str,
...
def main():
    ...
    # create model
    model = group_lasso_WideResNet(args.depth, num_classes, widen_factor=args.width, droprate_init = args.droprate_init,
