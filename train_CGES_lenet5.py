...
from lenet_models import CGES_LeNet5
...
parser.add_argument('--name', default='group_lasso_LeNet5', type=str,
...
def main():
    ...
    # create model
    model = CGES_LeNet5(num_classes, input_size=(1, 28, 28), conv_dims=(20, 50), fc_dims=500, N=60000,
