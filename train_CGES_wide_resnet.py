...
from wideresnet_models import CGES_WideResNet
from new_layers import CGES_Dense, CGES_Conv2d
...
parser.add_argument('--name', default='CGES_WideResNet', type=str,
...
parser.add_argument('--lamba', type=float, default=0.001,
                    help='Coefficient for the L1 term.')
...
def main():
    ...
    # create model
    model = CGES_WideResNet(args.depth, num_classes, widen_factor=args.width, droprate_init = args.droprate_init,
    	N=50000, beta_ema=args.beta_ema, weight_decay=args.weight_decay, lamba=args.lamba)
