...
parser.add_argument('--name', default='group_relaxed_L0Lenet', type=str,
...
def main():
    ...
    # create model
    if args.reg=='l0':
    	model = group_relaxed_L0LeNet5(num_classes, input_size=(1, 28, 28), conv_dims=(20, 50), fc_dims=500, N=60000,
                     weight_decay=args.weight_decay, lambas=args.lambas, beta = args.beta, local_rep=args.local_rep,
                     temperature=args.temp)
    elif args.reg=='l1':
        model = group_relaxed_L1LeNet5(num_classes, input_size=(1, 28, 28), conv_dims=(20, 50), fc_dims=500, N=60000,
                     weight_decay=args.weight_decay, lambas=args.lambas, beta = args.beta, local_rep=args.local_rep,
                     temperature=args.temp)
    elif args.reg=='l1l2':
        model = group_relaxed_L1L2LeNet5(num_classes, input_size=(1, 28, 28), conv_dims=(20, 50), fc_dims=500, N=60000,
                     weight_decay=args.weight_decay, lambas=args.lambas, beta = args.beta, local_rep=args.local_rep,
                     temperature=args.temp)
    elif args.reg=='SCAD':
        model = group_relaxed_SCADLeNet5(num_classes, input_size=(1, 28, 28), conv_dims=(20, 50), fc_dims=500, N=60000,
                     weight_decay=args.weight_decay, lambas=args.lambas, beta = args.beta, local_rep=args.local_rep,
                     temperature=args.temp)
    elif args.reg=='TF1':
        model = group_relaxed_TF1LeNet5(num_classes, input_size=(1, 28, 28), conv_dims=(20, 50), fc_dims=500, N=60000,
                     weight_decay=args.weight_decay, lambas=args.lambas, alpha = args.alpha, beta = args.beta, local_rep=args.local_rep,
                     temperature=args.temp)
