...
class group_relaxed_L1Dense(Module):
	...
	def __init__(self, in_features, out_features, bias=True, lamba=1., beta= 4., weight_decay=1., **kwargs):
		...
		"""
		super(group_relaxed_L1Dense,self).__init__()
	...
	def constrain_parameters(self, **kwargs):
		...
		m = Softshrink(self.lamba/self.beta)
...
class group_relaxed_L1Conv2d(Module):
	...
	def __init__(self, in_channels, out_channels, kernel_size, stride=1, padding=0, dilation=1, groups=1, bias=True,
		...
		"""
		super(group_relaxed_L1Conv2d, self).__init__()
		self.floatTensor = torch.FloatTensor if not torch.cuda.is_available() else torch.cuda.FloatTensor
