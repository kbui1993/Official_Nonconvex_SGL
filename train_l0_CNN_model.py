...
from ModelCNN_models import L0ModelCNN
...
parser.add_argument('--name', default='L0CNN', type=str,
...
def main():
    ...
    model = L0ModelCNN(lamba = args.lamba, local_rep = args.local_rep, temperature = args.temp)
